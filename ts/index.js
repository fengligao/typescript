...
var sentence = "My name is " + names + ". I'll be " + age + " years old next month.";
console.log('模版字符串', sentence);
var sentenceStr = "My name is " + names + ".  I'll be " + age + " years old next month.";
...
(function (Colors2) {
    ...
    Colors2[Colors2["pink"] = 3] = "pink";
})(Colors2 || (Colors2 = {}));
var c2 = Colors2.Green;
console.log('枚举2', c2);
// 或者全部采用手动赋值
var Colors3;
(function (Colors3) {
    Colors3[Colors3["red"] = 1] = "red";
    Colors3[Colors3["Green"] = 3] = "Green";
    Colors3[Colors3["pink"] = 4] = "pink";
})(Colors3 || (Colors3 = {}));
var c3 = Colors3.Green;
console.log('枚举3', c3);
// 枚举类型提供一个便利，就是你可以根据枚举的值，得到他的名字。例如
var Colors4;
(function (Colors4) {
    Colors4[Colors4["red"] = 1] = "red";
    Colors4[Colors4["Green"] = 4] = "Green";
    Colors4[Colors4["pink"] = 5] = "pink";
})(Colors4 || (Colors4 = {}));
var c4 = Colors4[4];
console.log('枚举4', c4);
